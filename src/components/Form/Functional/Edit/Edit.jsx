      ...
      <form className={`${style["form"]} row g-3`} onSubmit={saveFields}>
        ...
        <div className="col-md-3">
          <Input
            ...
            type={"text"}
            label={"CRM"}
            placeholder={"CRM do Funcionário (Se for Médico)"}
            disabled={disabled}
            value={userEdit.crm}
          />
        </div>
        ...
        <div className="col-md-3">
          <Input
            ...
            value={userEdit.registry}
            disabled={disabled}
          />
        </div>
        <div className="col-md-3">
          <label htmlFor="patientCep" className="form-label">
            CEP*
          </label>
          <input
            type="text"
        ...
        <div className="col-md-3">
          <label htmlFor="patientStreet" className="form-label">
            Rua
          </label>
          <input
            type="text"
        ...
        <div className="col-md-3">
          <Input
            ...
            value={userEdit.complemento}
            disabled={disabled}
          />
        </div>
        <div className="col-md-3">
          <label htmlFor="patientNeighborhood" className="form-label">
            Bairro
          </label>
          <input
            type="text"
            ...
            value={userEdit.neighborhood}
            placeholder="Bairro do Funcionário"
            disabled
          />
        </div>
        <div className="col-md-3">
          <label htmlFor="patientCity" className="form-label">
            Cidade
          </label>
          <input
            type="text"
